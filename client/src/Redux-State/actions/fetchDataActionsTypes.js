...
export const LOGIN_USER_FAILURE = "FETCH_USER_FAILURE";
export const LOGIN_USER_SUCCESS = "FETCH_USER_SUCCESS";
export const LOGIN_USER_REQUEST = "FETCH_USER_REQUEST";
