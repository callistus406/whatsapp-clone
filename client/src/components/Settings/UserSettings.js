...
//     class=">
//     <path d="M12 1l3.22 3.22h4.56v4.56L23 12l-3.22 3.22v4.56h-4.56L12 23l-3.22-3.22H4.22v-4.56L1 12l3.22-3.22V4.22h4.56L12 1zm0 5v12c3.31 0 6-2.69 6-6a6.005 6.005 0 0 0-5.775-5.996L12 6z"
//     fill="#919191"></path></svg>
//   );
// }
const optionText = [
  "Notification",
    ...
    <div className="settings">
      <StyledContainer toggle={props.toggle} width="28rem">
        ...
        <div className="settingsContent">
          ...
          {optionText.map(function (item, index) {
            return <SettingsOptions icon={options[index]} text={item} />;
          })}
        </div>
      </StyledContainer>
    </div>
